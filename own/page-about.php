...
<main id="main">
  ...
  <div class="page-hero">
    <div style="max-width:1200px;margin-inline:auto;">
      ...
      <h1 class="page-hero__ja">鳥取在住のホームページ制作者 川上凌について</h1>
    ...
    <div style="max-width:1200px;margin-inline:auto;">
      <div class="about-profile reveal">
        ...
        <div>
          ...
          <p class="about-profile__name-ja">Own. / 鳥取のホームページ制作・SEO事業</p>
            ...
            if ( have_posts() ) :
              while ( have_posts() ) : the_post();
                ...
                if ( trim( $content ) ) :
                  ...
                  <p>「いいもの」が埋もれてしまう時代を終わりにしたい。Webが苦手な方でも、その情熱が正しく届く仕組みを一緒に作りたい。——そんな思いでホームページ制作・SEO対策・MEO対策・サイト保守を一貫して提供しています。</p>
                  ...
                  <p>ホームページ制作にとどまらず、アパレルやカフェ、鳥取特化のメディアなど、own.をひとつの大きなブランドに育てていくことが目標です。</p>
                  <p>代表・川上について、もっと知りたくなったら。<br>プライベートも仕事も、日々の気づきをゆるっと書いてます → <a href="https://note.com/r_kwkm/portal" target="_blank" rel="noopener" class="bio-link">note</a></p>
                <?php
                endif;
              endwhile;
            endif; ?>
