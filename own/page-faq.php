  ...
  <div class="page-hero">
    <div style="max-width:1200px;margin-inline:auto;">
      ...
      <p class="page-hero__lead">
        鳥取でホームページ制作・SEO対策をご検討の方からよくいただく質問をまとめました。<br>
        ...
        [
          ...
          'items' => [
            ['鳥取でホームページ制作を依頼すると費用はどのくらいかかりますか？',
             'ミニマムプランで15万円〜が目安です。ページ数・デザインの複雑さ・機能によって変動します。まずはご要望をお聞きして無料でお見積りします。'],
            ['予算が少ないのですが、相談できますか？',
             'もちろんです。「〇〇万円でできることを教えてほしい」といったご相談も大歓迎です。予算内で最大の効果を出せるプランをご提案します。'],
            ['月額費用はかかりますか？',
             'ホームページ制作のみであれば制作費のみです。保守プラン（月3万円〜）・SEO対策（月5万円〜）は任意のオプションです。'],
            ['分割払いはできますか？',
