...
<main id="main">
  ...
  <section style="padding:10rem 3rem;text-align:center;">
    <div style="max-width:600px;margin-inline:auto;">
      ...
      <p style="font-size:0.95rem;color:var(--muted);line-height:1.9;margin-bottom:3rem;">ホームページ制作・SEO・MEOに関するコンテンツを準備中です。<br>もうしばらくお待ちください。</p>
      <a href="<?php echo esc_url( home_url('/') ); ?>" style="font-family:var(--font-en);font-size:0.8rem;font-weight:600;letter-spacing:0.08em;color:var(--muted);text-decoration:none;border:1px solid var(--border);padding:0.6em 1.5em;display:inline-block;transition:color 0.2s,border-color 0.2s;">← Back to Home</a>
    </div>
  </section>
